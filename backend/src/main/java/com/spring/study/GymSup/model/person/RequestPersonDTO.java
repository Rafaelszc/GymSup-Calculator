...
public record RequestPersonDTO(int height, double weight, int age,
                               Sex sex, DietType dietType, PersonRoutine routine) {

    public RequestPersonDTO(int height, double weight, int age, Sex sex, DietType dietType, PersonRoutine routine) {
        this.height = height;
        this.weight = weight;
        this.age = age;
        this.sex = sex;
